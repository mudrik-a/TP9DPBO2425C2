...
(1, 'Lewis Hamilton', 'Mercedes', 'United Kingdom', 347, 12),
...
CREATE TABLE `sponsor` (
  ...
  `jenis_industri` varchar(255) NOT NULL,
...
INSERT INTO `sponsor` (`id`, `nama_brand`, `jenis_industri`, `nilai_kontrak`) VALUES
(1, 'Monster Energy', 'Minuman Energi', 150000000.00),
(2, 'Petronas', 'Minyak & Gas', 200000000.00),
(3, 'Red Bull', 'Minuman Energi', 300000000.00),
(4, 'Mission Winnow', 'Tembakau', 120000000.00);
